                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item  ">
                                    <a href="/list" class="nav-link ">
                                        <span class="title">لیست دانشجویان/نمره دهی</span>
                                    </a>
                                </li>
                                <%--<li class="nav-item  ">--%>
                                ...
                                <%--</li>--%>
                                <li class="nav-item  ">
                                    <a href="/profprofile" class="nav-link ">
                                        <span class="title">ویرایش حساب</span>
                                    </a>
                                </li>
                                <li class="nav-item  ">
                                    <a href="/proflog_out" class="nav-link ">
                ...
                <div class="page-content">
                    ...
                    <div class="page-head">
                        ...
                        <div class="page-title">
                            <h1>لیست دانشجویان و نمره دهی
                                <small>توسط استاد</small>
                            </h1>
                        </div>
                        <!-- END PAGE TITLE -->
                        <!-- BEGIN PAGE TOOLBAR -->
                                ...
                                <div class="portlet light bordered">
                                            ...
                                            <div class="portlet-body form">
                                                ...
                                                <form action="#" class="form-horizontal">
                                                    <div class="form-body">
                                                        <h3 class="form-section" style="font-family: 'nasim'">لیست دانشجویان</h3>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="control-label col-md-3"> کد ترم</label>
                                                                    <div class="col-md-9">
                                                                        <input type="text" class="form-control" placeholder="کد ترم">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <input type="text" class="form-control" placeholder="کد درس">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="note note-success">
                                <p> در جدول زیر لیست دانشجویان مربوط به ترم مورد نظر قرار دارد </p>
                            </div>
                            <!-- BEGIN SAMPLE TABLE PORTLET-->
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-cogs"></i> لیست دانشجویان </div>
                                    <div class="tools">
                                ...
                                <div class="portlet-body flip-scroll">
                                    <table class="table table-bordered table-striped table-condensed flip-content">
                                        <thead class="flip-content">
                                            <tr>
                                                <th width="20%"> کد انتخاب  </th>
                                                <th width="20%"> کد درس  </th>
                                                <th> نام درس </th>
                                                <th class="numeric"> تعداد واحد </th>
                                                <th class="numeric"> نوع درس  </th>
                                                <th class="numeric"> کد دانشجو  </th>
                                                <th class="numeric"> نام دانشجو  </th>
                                        ...
                                        <c:forEach var="sel" items="${Course}">
                                            <tr>
                                                ...
                                                <td> <c:out value="${sel.studentID.studentID}"/> </td>
                                                <td> <c:out value="${sel.studentID.studentName}"/> </td>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                                ...
                                <div class="portlet light bordered">
                                            ...
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                                                <form action="prof_score" method="post" class="form-horizontal">
                                                    <div class="form-body">
                                                        <h3 class="form-section" style="font-family: 'nasim'">فرم نمره دهی</h3>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <label class="control-label col-md-3">نمره</label>
                                                                    <div class="col-md-9">
                                                                        <input name="Score" type="number" class="form-control" placeholder="نمره">
