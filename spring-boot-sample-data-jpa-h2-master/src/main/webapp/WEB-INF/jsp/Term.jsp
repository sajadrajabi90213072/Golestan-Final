        ...
        <div class="page-container">
                    ...
                    <ul class="page-sidebar-menu   " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                        ...
                        <li class="nav-item  ">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item  ">
                                    <a href="/DefineLesson" class="nav-link ">
                                ...
                                <li class="nav-item  ">
                                    <a href="/Term" class="nav-link ">
                                        <span class="title"> ارائه دروس باری ترم </span>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item  ">
                                    <a href="/adminlog_out" class="nav-link ">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="page-head">
                        <!-- BEGIN PAGE TITLE -->
                        <div class="page-title" style="font-family: 'nasim' ;">
                            <h1> 
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="note note-success">
                                <p> در جدول زیر لیست درسها به همراه کد و شرایط انها ذکر شده است </p>
                            </div>
                            <!-- BEGIN SAMPLE TABLE PORTLET-->
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-cogs"></i> جدول درس ها  </div>
                                    <div class="tools">
                                ...
                                <div class="portlet-body flip-scroll">
                                    <table class="table table-bordered table-striped table-condensed flip-content">
                                        ...
                                        <c:forEach var="sel" items="${Course}">
                                            <tr>
                                                <td> <c:out value="${sel.courseID}"/> </td>
                                                <td> <c:out value="${sel.courseName}"/> </td>
                                                <td> <c:out value="${sel.courseScore}"/> </td>
                                                <td> <c:out value="${sel.courseType}"/> </td>
                                                <td> <c:out value="${sel.courseGroup}"/> </td>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="note note-success">
                                <p> در جدول زیر لیست استادها به همراه کد و شرایط انها ذکر شده است </p>
                            </div>
                            <!-- BEGIN SAMPLE TABLE PORTLET-->
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-cogs"></i> جدول استاد  </div>
                                    <div class="tools">
                                        <a href="javascript:;" class="collapse"> </a>
                                        <a href="#portlet-config" data-toggle="modal" class="config"> </a>
                                        <a href="javascript:;" class="reload"> </a>
                                ...
                                <div class="portlet-body flip-scroll">
                                    <table class="table table-bordered table-striped table-condensed flip-content">
                                        ...
                                        <tr>
                                            ...
                                            <th width="20%"> کد استاد  </th>
                                            <th> نام استاد </th>
                                            <th class="numeric"> تخصص </th>
                                            <th class="numeric"> مدرک  </th>
                                        ...
                                        <c:forEach var="sel2" items="${Prof}">
                                            <tr>
                                                <td> <c:out value="${sel2.profID}"/> </td>
                                                <td> <c:out value="${sel2.profName}"/> </td>
                                                <td> <c:out value="${sel2.profField}"/> </td>
                                                <td> <c:out value="${sel2.profDegree}"/> </td>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="note note-success">
                                <p> در جدول زیر لیست استادها و درس ها با هم ، به همراه کد و شرایط انها ذکر شده است </p>
                            </div>
                            <!-- BEGIN SAMPLE TABLE PORTLET-->
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-cogs"></i> جدول دروس ارائه شده  </div>
                                    <div class="tools">
                                        <a href="javascript:;" class="collapse"> </a>
                                        <a href="#portlet-config" data-toggle="modal" class="config"> </a>
                                        <a href="javascript:;" class="reload"> </a>
                                ...
                                <div class="portlet-body flip-scroll">
                                    <table class="table table-bordered table-striped table-condensed flip-content">
                                        ...
                                        <c:forEach var="sel" items="${profcourse}">
                                            <tr>
                                        ...
                                        <div class="portlet light bordered">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    ...
                                                    <span class="caption-subject font-red-sunglo bold uppercase">فرم تعریف ترم
                                                </div>
                                                <div class="tools">
                                            ...
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                                                <form action="CreateTerm" method="post" class="form-horizontal">
                                                    <div class="form-body">
                                                        <h3 class="form-section" style="font-family: 'nasim'">اطلاعات ترم</h3>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="control-label col-md-3"> ترم</label>
                                                                    <div class="col-md-9">
                                                                        <input name="term" type="text" class="form-control" placeholder=" ترم">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <label class="control-label col-md-3"> سال تحصیلی</label>
                                                                    <div class="col-md-9">
                                                                        <input name="year" type="text" class="form-control" placeholder=" سال تحصیلی">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <label class="control-label col-md-3">کد درس  </label>
                                                                    <div class="col-md-9">
                                                                        <input name="course" type="number" min="1" max="100000000" class="form-control" placeholder="کد درس ">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <label class="control-label col-md-3">کد استاد  </label>
                                                                    <div class="col-md-9">
                                                                        <input name="prof" type="number" min="1" max="100000000" class="form-control" placeholder="کد استاد   ">
...
<![endif]-->
        ...
        <script src="pages/scripts/form-samples.min.js" type="text/javascript"></script>
