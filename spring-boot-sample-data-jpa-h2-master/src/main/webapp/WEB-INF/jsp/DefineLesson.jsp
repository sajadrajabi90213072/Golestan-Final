                ...
                <div class="page-content">
                    ...
                    <div class="page-head">
                        ...
                        <div class="page-title">
                            <h1>تعریف و تغییر درس
                                <small>توسط مدیر</small>
                            </h1>
                        </div>
                        <!-- END PAGE TITLE -->
                        <!-- BEGIN PAGE TOOLBAR -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-cogs"></i> جدول درس ها جهت اخذ </div>
                                    <div class="tools">
                        ...
                        <div class="col-md-12">
                                ...
                                <div class="portlet light bordered">
                                            ...
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                                                <form action="DefLess" method="post" class="form-horizontal">
                                                    <div class="form-body">
                                                        <h3 class="form-section" style="font-family: 'nasim'">فرم تعریف درس</h3>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="control-label col-md-3"> نام درس</label>
                                                                    <div class="col-md-9">
                                                                        <input  name="name" type="text" class="form-control" placeholder="نام درس">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <label class="control-label col-md-3">تعداد واحد </label>
                                                                    <div class="col-md-9">
                                                                        <input name="score" type="text" class="form-control" placeholder="تعداد واحد " >
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="control-label col-md-3"> نوع درس</label>
                                                                    <div class="col-md-9">
                                                                        <input  name="type" type="text" class="form-control" placeholder="نوع درس">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <label class="control-label col-md-3">گروه درس </label>
                                                                    <div class="col-md-9">
                                                                        <input name="group" type="text" class="form-control" placeholder="گروه درس" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                    <form action="UpdateLess" method="post" class="form-horizontal">
                                        <div class="form-body">
                                            <h3 class="form-section" style="font-family: 'nasim'">فرم تغییر</h3>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <label class="control-label col-md-3">نوع درس</label>
                                                        <div class="col-md-9">
                                                            <input name="type" type="text" class="form-control" placeholder="نوع درسُُ" >
                                            ...
                                            <div class="row">
                                                ...
                                                <%--<div class="col-md-6">--%>
                                                    <%--<div class="form-group">--%>
                                                        ...
                                                        <%--<div class="col-md-9">--%>
                                                            <%--<input name="name" type="text" class="form-control" placeholder="کد استاد" >--%>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                    <form action="DeleteLess" method="post" class="form-horizontal">
                                        <div class="form-body">
                                            <h3 class="form-section" style="font-family: 'nasim'">فرم حذف درس</h3>
