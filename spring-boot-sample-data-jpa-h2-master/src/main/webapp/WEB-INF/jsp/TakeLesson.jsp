                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="note note-success">
                                <p> در جدول زیر لیست درسهای ترم به همراه کد و شرایط انها ذکر شده است </p>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-cogs"></i> جدول درس های اخذ شده  </div>
                                    <div class="tools">
                                        <a href="javascript:;" class="collapse"> </a>
                                        <a href="#portlet-config" data-toggle="modal" class="config"> </a>
                                        <a href="javascript:;" class="reload"> </a>
                                ...
                                <div class="portlet-body flip-scroll">
                                    <table class="table table-bordered table-striped table-condensed flip-content">
                                        ...
                                        <c:forEach var="select" items="${MyCourse}">
                                            <tr>
                                                <td> <c:out value="${select.id}"/> </td>
                                                <td> <c:out value="${select.courseID.courseID}"/> </td>
                                                <td> <c:out value="${select.courseID.courseName}"/> </td>
                                                <td> <c:out value="${select.courseID.courseScore}"/> </td>
                                                <td> <c:out value="${select.profID.profID}"/> </td>
                                                <td> <c:out value="${select.profID.profName}"/> </td>
                                                <td> <c:out value="${select.year}"/> </td>
                                                <td> <c:out value="${select.term}"/> </td>
                                            </tr>
                                        </c:forEach>
                        ...
                        <div class="col-md-12">
                                ...
                                <div class="portlet light bordered">
                                            ...
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                                                <form action="take_lesson" method="post" class="form-horizontal">
                                                    <div class="form-body">
                                                        <h3 class="form-section" style="font-family: 'nasim'">فرم اخذ</h3>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <%--<div class="col-md-6">--%>
                                                                <%--<div class="form-group">--%>
                                                                    ...
                                                                    <%--<div class="col-md-9">--%>
                                                                        <%--<input type="text" class="form-control" placeholder="کد استاد" >--%>
                                                                        <%----%>
                                                                    <%--</div>--%>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                    <form action="delete_lesson" method="post" class="form-horizontal">
                                        <div class="form-body">
                                            <h3 class="form-section" style="font-family: 'nasim'">فرم حذف</h3>
